...
export class WineryFileComparisonComponent implements OnChanges {
    ...
    @Input() accountabilityService: AccountabilityService; // instead of constructor injection to avoid importing the
     ...
     * @returns {any[]} the set of file versions (SelectEntries {id, text}) that refer to the specified file
     */
    getProvenanceVersionTitles(fileId: string): any[] {
    ...
    convertProvenanceElementToSelectEntry(element: ProvenanceElement): any {
