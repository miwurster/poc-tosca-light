...
public class EnhancementUtils {
     ...
     *
     * @param featureMap The list of available features as generated by {@link EnhancementUtils#getAvailableFeaturesForTopology(TTopologyTemplate)}
     * @return The mapping of the generated merged NodeType and the QName of the NodeType it replaces.
     */
    static Map<QName, TNodeType> createFeatureNodeTypes(Map<QName, Map<QName, String>> featureMap) {
        IRepository repository = RepositoryFactory.getRepository();
        Map<QName, TNodeType> nodeTypes = repository.getQNameToElementMapping(NodeTypeId.class);
        ...
        featureMap.forEach((qName, featureTypes) -> {
            // merge type
