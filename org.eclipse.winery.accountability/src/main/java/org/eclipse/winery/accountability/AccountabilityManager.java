...
public interface AccountabilityManager {
     ...
     */
    CompletableFuture<Map<String, String>> storeState(Map<String, byte[]> files);
     ...
     */
    CompletableFuture<String> storeState(byte[] data);
     ...
     */
    CompletableFuture<byte[]> retrieveState(String addressInImmutableStorage);
